<?php require 'section/header.php';?>
    ...
    <div class="container text-right">
        <form action="Sinfo.php?time_taken_id=<?php echo $row["time_taken_id"]?>&melicode=<?php echo $melicode?>" method="POST">
            <h2>اطلاعات مراجعه</h2>
            ...
            <div class="form-group">
                <label style="margin-left: 89%">معاینه: </label>
